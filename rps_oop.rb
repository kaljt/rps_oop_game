...
module Hand
  ...
  def compare_hands(p2)
    if @hand_throw == p2.hand_throw
      puts "It's a tie!"
    elsif ((@hand_throw == 'PAPER' && p2.hand_throw == 'ROCK') || (@hand_throw == 'ROCK' && p2.hand_throw == 'SCISSORS') || (@hand_throw == 'SCISSORS' && p2.hand_throw == 'PAPER'))
  ...
  #  if @hand_throw == p2.hand_throw
  #   puts "It's a tie!"
  # elsif @hand_throw > p2.hand_throw
  #   puts "#{@name} wins!"
  # else
  #   puts "#{p2.name} wins!"
  # end
...
class Game
  ...
  while true
    ...
    CHOICES.values.each do |gesture|
      ...
      print "........"
      sleep 0.5
      #if gesture == CHOICES.values.last
      #  print "SHOOT!  "
      #end
    end
    puts "SHOOT!"
